# سجل التغييرات الرسمي (CHANGELOG) - تطبيق الدَّلاَّل (Release 2026.1 - v2.0.0-stable)

يوثق هذا الملف التحسينات، الإصلاحات، والترقيات الهيكلية التي تم إدخالها في إصدار تطبيق **الدَّلاَّل Release 2026.1 (v2.0.0-stable)** والمكوّن الموحد **FractionHelper v2.0.0**.
